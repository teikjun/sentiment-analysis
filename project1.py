...
def hinge_loss_full(feature_matrix, labels, theta, theta_0):
    ...
    overall_hinge_loss = hinge_loss_sum / data_size 
    return overall_hinge_loss
...
def perceptron(feature_matrix, labels, T):
    ...
    # Code
    # Initialize to 0
    dimension = np.shape(feature_matrix)[1]
...
def average_perceptron(feature_matrix, labels, T):
    ...
    average_theta = sum_theta / count
    average_theta_0 = sum_theta_0 / count
...
def classify(feature_matrix, theta, theta_0):
    ...
    for feature_vector in feature_matrix:
        signed_distance = np.dot(feature_vector, theta) + theta_0
...
def classifier_accuracy(
    ...
    train_classifications = classify(train_feature_matrix, train_theta, train_theta_0)
    train_accuracy = accuracy(train_classifications, train_labels)

    val_classifications = classify(val_feature_matrix, train_theta, train_theta_0)
    val_accuracy = accuracy(val_classifications, val_labels)
